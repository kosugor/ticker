...
```dotenv
TICKER_FUND_ADAPTER=intesa_invest,raiffeisen_invest,nlb_fondovi,otp_invest,unicredit_invest
```
...
| `TICKER_FUND_ADAPTER` | unset; comma-separated `intesa_invest`, `raiffeisen_invest`, `nlb_fondovi`, `otp_invest`, and/or `unicredit_invest` |
